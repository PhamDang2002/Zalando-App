...
Khi liệt kê sản phẩm, mỗi sản phẩm hãy ghi trên một dòng, trình bày ngắn gọn, có thể dùng dấu gạch đầu dòng (-). Nếu có hình ảnh, hãy chèn link ảnh. Kèm theo đó là link chi tiết sản phẩm dạng: http://localhost:5173/products/_id. Không giải thích dài dòng, chỉ liệt kê sản phẩm phù hợp.
${userMessage}`,
        },
      ]);
    }, 600);
